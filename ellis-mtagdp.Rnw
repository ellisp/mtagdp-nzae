...
In this section I work through an example analysis of the MTAGDP data in the hope that it will motivate others to attempt similar analyses and integrate the data into ongoing research programs.  
...
concluding remarks something like
Doubtless some of the most interesting findings will turn out to be artefacts of the modelling process.
